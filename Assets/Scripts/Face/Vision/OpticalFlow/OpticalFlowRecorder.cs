...
public class OpticalFlowRecorder : MonoBehaviour
{
    ...
    [SerializeField]
    private OpticalFlowAccumVis opticalFlowAccumVis;
    ...
    void Update()
    {
        ...
        SaveRenderTextureToFile(opticalFlowAccumVis.GetOpticalFlowAccumTexture(), "accum_" + iFrame);
        iFrame++;
    }
    ...
    private void SaveRenderTextureToFile(RenderTexture renderTexture, string filename)
    {
       var currentRT = RenderTexture.active;
